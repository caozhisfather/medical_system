...
def training_score(payload: TrainingScoreRequest) -> dict[str, Any]:
    ...
    return scoring_agent.score(case, transcript, ordered_tests, payload.preliminary_diagnosis, payload.differentials, payload.treatment_principles, payload.citations)
