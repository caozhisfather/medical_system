export const mockAnatomyExercises = [
  {
    ...
    "substructures": [
      { "name": "右心房", "category": "心腔", "description": "接收上、下腔静脉与冠状窦回流的静脉血。", "clinical_note": "关注中心静脉压与右心衰体征。" },
      { "name": "右心室", "category": "心腔", "description": "经肺动脉瓣将血液泵入肺循环。", "clinical_note": "肺动脉高压可导致右心室负荷增加。" },
      { "name": "左心房", "category": "心腔", "description": "接收四条肺静脉回流的含氧血。", "clinical_note": "房颤相关血栓常与左心耳有关。" },
      { "name": "左心室", "category": "心腔", "description": "经主动脉瓣将血液泵入体循环，心肌壁最厚。", "clinical_note": "左室射血分数用于评价收缩功能。" },
      { "name": "三尖瓣", "category": "房室瓣", "description": "位于右心房与右心室之间，防止收缩期血液反流。" },
      { "name": "二尖瓣", "category": "房室瓣", "description": "位于左心房与左心室之间，由前、后瓣叶构成。" },
      { "name": "肺动脉瓣", "category": "半月瓣", "description": "位于右心室流出道与肺动脉干之间。" },
      { "name": "主动脉瓣", "category": "半月瓣", "description": "位于左心室流出道与升主动脉之间。" },
      { "name": "室间隔", "category": "心脏间隔", "description": "分隔左右心室，包含膜部与肌部。", "clinical_note": "室间隔膜部是室间隔缺损常见部位。" }
    ],
    "video_resources": [
      { "title": "心脏精细解剖讲解", "url": "", "platform": "bilibili", "status": "待收集", "contributor": "待分配" }
    ],
    "graph_node_ids": [
      "acs",
      "ecg",
  ...
  },
  {
    ...
    "substructures": [
      { "name": "左肺上叶", "category": "肺叶", "description": "包括尖后段、前段和舌段等区域。" },
      { "name": "左肺下叶", "category": "肺叶", "description": "包含背段和多个基底段。" },
      { "name": "肺门", "category": "出入结构", "description": "支气管、肺血管、淋巴管和神经出入肺的区域。" },
      { "name": "胸膜", "category": "被膜", "description": "由脏层胸膜与壁层胸膜构成，二者之间为胸膜腔。" }
    ],
    "graph_node_ids": [
      "dyspnea",
      "pulmonary_embolism",
  ...
  },
  {
    ...
    "substructures": [
      { "name": "肝右叶", "category": "肝叶", "description": "解剖上体积最大的肝叶。" },
      { "name": "肝左叶", "category": "肝叶", "description": "位于镰状韧带左侧，部分覆盖胃前方。" },
      { "name": "肝门", "category": "出入结构", "description": "肝固有动脉、门静脉和肝管等结构出入。" },
      { "name": "肝段", "category": "功能分区", "description": "按门静脉与肝静脉走行可划分为八个功能性肝段。", "clinical_note": "肝段划分用于影像定位与手术规划。" }
    ],
    "graph_node_ids": [
      "jaundice",
      "liver_function",
  ...
  },
  {
    ...
    "substructures": [
      { "name": "肾皮质", "category": "实质", "description": "位于肾脏外层，包含肾小体和曲细尿管。" },
      { "name": "肾髓质", "category": "实质", "description": "由肾锥体等结构组成，与尿液浓缩密切相关。" },
      { "name": "肾盂", "category": "集合系统", "description": "汇集肾大盏尿液并延续为输尿管。" },
      { "name": "肾门", "category": "出入结构", "description": "肾血管、肾盂、淋巴管和神经出入区域。" }
    ],
    "graph_node_ids": [
      "urinalysis",
      "renal_function"
  ...
  },
  {
    ...
    "substructures": [
      { "name": "额叶", "category": "大脑半球", "description": "参与执行功能、随意运动和语言表达。" },
      { "name": "顶叶", "category": "大脑半球", "description": "整合躯体感觉与空间信息。" },
      { "name": "颞叶", "category": "大脑半球", "description": "参与听觉、记忆与语言理解。" },
      { "name": "枕叶", "category": "大脑半球", "description": "包含主要视觉皮层。" },
      { "name": "基底核", "category": "皮质下结构", "description": "参与运动调节与程序性学习。", "clinical_note": "基底核损害可出现多种运动障碍。" }
    ],
    "graph_node_ids": [
      "headache",
      "stroke",
