...
function finishTraining() {
  const report = trainingStore.submitSession();
...
<template>
  <main v-if="session" class="patient-room">
    <header class="room-header">
      ...
      <div class="room-progress"><span>过程评分</span><strong>{{ scoreAverage }}</strong></div>
      <button class="button-secondary" type="button" @click="finishTraining">结束并生成报告 <FileCheck2 :size="17" /></button>
    </header>
    ...
    <div class="room-layout">
      ...
      <section class="patient-dialogue">
        <div class="dialogue-heading">
          ...
          <span class="patient-state"><i></i> 病人在线</span>
        </div>
      ...
      <aside class="reasoning-rail">
        ...
        <button class="button-primary submit-thinking" type="button" @click="finishTraining">提交临床思维 <ChevronRight :size="18" /></button>
      </aside>
    </div>
  </main>
</template>
